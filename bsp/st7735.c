...
#define TFT_BL_H()		GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_BL_Pin, SET)
#define TFT_BL_L()		GPIO_WritePin(ST7735_BL_GPIO_Port, ST7735_BL_Pin, RESET)
#define TFT_CS_H()		GPIO_WritePin(ST7735_CS_GPIO_Port, ST7735_CS_Pin, SET)
#define TFT_CS_L()		GPIO_WritePin(ST7735_CS_GPIO_Port, ST7735_CS_Pin, RESET)
#define TFT_DC_D()		GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, SET)
#define TFT_DC_C()		GPIO_WritePin(ST7735_DC_GPIO_Port, ST7735_DC_Pin, RESET)
#define TFT_RES_H()		GPIO_WritePin(ST7735_RES_GPIO_Port, ST7735_RES_Pin, SET)
#define TFT_RES_L()		GPIO_WritePin(ST7735_RES_GPIO_Port, ST7735_RES_Pin, RESET)
...
//	TFT_CS_L();
//
//	char float_value[1] = {0};
//	sprintf(float_value, " %g" ,value);
//	char* buff = calloc(strlen(str) + strlen(float_value) + 1, 1);
//	strcat(buff, str);
//	strcat(buff, float_value);
//
//    while(*buff)
//    {
//        if(x + font.width >= _width)
...
//        }
//
//        ST7735_WriteChar(x, y, *buff, font, color, bgcolor);
//        x += font.width;
//        buff++;
//    }
//    TFT_CS_H();
